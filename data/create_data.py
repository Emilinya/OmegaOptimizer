...
if len(sys.argv) == 1:
    sys.exit("Create_data must get a function as an argument")
...
if sys.argv[1] == "sqrt":
    ...
    x_ray = np.linspace(
        true_params[1] - 3 * true_params[2], true_params[1] + 3 * true_params[2], 500
    )
    ...
    sys.exit(f"Unknown argument {sys.argv[1]}")
